...
function Navbar() {
  ...
  return (
    <>
        <div ref={menuRef} className='bg-white shadow-md fixed w-full top-0 z-50'>
            <div className='flex items-center justify-between z-50 container mx-auto relative px-8 md:px-10 py-3'>
                ...
                <div className='hidden md:flex items-center gap-6'>
                    ...
                    {/* <div className='text-sm hover:opacity-70 transition duration-300'><a href="#whyus">Why us</a></div> */}
                    <Navbaritems route='/service' title='Services'/>
                    <Navbaritems route='/about' title='About us'/>
                    {/* <Navbaritems route="#testimonials" title='Testimonials'/> */}
