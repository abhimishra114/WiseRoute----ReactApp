...
function HomeBlock() {
  ...
  return (
    <>
        <div data-aos="zoom-out" className="grid grid-cols-1 cursor-pointer md:grid-cols-3 px-5 gap-8 mb-8 container mx-auto">
            {/* <!-- first-block --> */}
            <div  className="box flex flex-col items-center text-center rounded-lg gap-5 md:gap-3 p-8 justify-evenly transition duration-500 lg:hover-box">
            ...
            {/* <!-- Second-block --> */}
            <div className="box flex flex-col items-center text-center rounded-lg gap-5 md:gap-3 p-8 transition duration-500 lg:hover-box">
