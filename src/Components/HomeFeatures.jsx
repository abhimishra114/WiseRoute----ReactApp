  ...
  return (
    <>
        ...
        <section className="px-10 mt-10 container">
            <div data-aos="fade-up" className="my-16 text-3xl text-lines">Features</div>
            {/* <!-- features 1 --> */}
            <div data-aos="fade-left" className="flex flex-col sm:flex-row items-center mb-5">
            ...
            {/* <!-- features 2 --> */}
            <div data-aos="fade-right" className="flex flex-col-reverse sm:flex-row items-center mb-5">
